...
class Main extends Component{
    ...
    search = (e) => {
        ...
        if(this.state.Data === '') return alert('message missing...search field cannot be empty')
                                    ...
                                    <div className="col-lg-12 col-md-12">
                                        ...
                                        <div className="container">
                                            <div className="check">
                                                ...
                                                placeholder={this.state.checked ? 'Go Direct to The user Profile' : 'Enter username...'}
